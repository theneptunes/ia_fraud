...
import pydot
def visualization(rf, train_features, train_labels, feature_list):
...
def random_forest(localizacao, valor, periodo, categoria):
    ...
    visualization(rf, train_features, train_labels, feature_list)
...
sys.modules[__name__] = random_forest